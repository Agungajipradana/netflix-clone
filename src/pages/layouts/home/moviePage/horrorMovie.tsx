...
import { getGenreMovieList, getMovieByGenreHorrorList } from "@/utils";
...
const HorrorMoviePage = () => {
  ...
  useEffect(() => {
    getMovieByGenreHorrorList().then((result) => {
  ...
  return (
    <div className="bg-[#141414] text-white  font-bebas-neue">
      <h1 className="text-2xl font-semibold ml-4 mb-5 pt-20 md:text-3xl md:pt-5 relative">Horror Movie</h1>
